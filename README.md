...
![equation](https://latex.codecogs.com/svg.latex?r_{t+1}+\gamma%20Q(s_{t+1},%20a_{t+1}))

Q学习算法的公式：

![equation](https://latex.codecogs.com/svg.latex?r_{t+1}+\gamma%20\underset{a}{\max}%20Q(s_{t+1},%20a))
